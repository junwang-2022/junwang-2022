...
%let export_loc=D:\SASData\dua_052882\Sndbx\Jun_W\builder test\Builder v11\test v11\export;
%let report_loc=D:\SASData\dua_052882\Sndbx\Jun_W\builder test\Builder v11\test v11\final_report;
%let npi_loc=D:\SASData\dua_052882\Sndbx\Jun_W\builder test\NPI;  
...
libname epi "&agg_loc.\py&py.";
libname tcc "&tcc_loc.\py&py.";
libname export "&export_loc.\py&py.";
libname report "&report_loc.\py&py.";

libname qc "&qc_loc.";
libname meta2 "&meta2_loc";
libname npi "&npi_loc";
...
select distinct episode_type, episode_id, episode_name, a.*, b.*, c.*,
...
on a.def_sub=b.def_sub
left join (select distinct episode_id, count(distinct provider_id) as final_npi_cnt from export.export_attr_npi_epi_spec where measure="t_epi_pay" group by episode_id) c
...
data qc_&tbl.;
set 
report.export_attr_npi_&tbl.
export.export_attr_tin_&tbl.
export.export_attr_p_bill_&tbl.
export.export_attr_f_bill_&tbl.
export.export_attr_ccn_&tbl.
;
run;
proc sql;
...
from qc_cbd(where=(phase in ("All" "N/A") and clm_type="All" and service_description="All")) a
...
proc freq data=report.export_attr_npi_comb;
tables measure*rollup_type*rollup_description*rollup_description2/list missing;
run;
