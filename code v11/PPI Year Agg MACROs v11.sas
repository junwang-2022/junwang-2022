...
proc sql;
create table svc3_&epi. as
select def_sub, def_id, phase, clm_type, svc_cat, svc_sub2 as svc_sub, sum(allowed_amt) as tot_amt
from svc2_&epi.
...
left join meta2.npi_x_spec_&year. b on a.attr_npi^="" and a.attr_npi=b.npi
...
left join meta2.npi_x_spec_&year. b on a.prf_npi^="" and a.prf_npi=b.npi
left join meta2.ppi_spec_mapping c on a.def_sub=c.def_sub and b.spec_cd^="" and b.spec_cd=c.spec_cd
having spec_cd^=""
...
left join meta2.npi_x_spec_&year. e on coalescec(d.prf_npi,c.attr_npi)^="" and coalescec(d.prf_npi,c.attr_npi)=e.npi
...
left join meta2.npi_x_tin_&year. b2 on b2.prf_npi=a.attr_npi
left join epi_bill_&epi. c1 on a.def_sub=c1.def_sub and a.def_id=c1.def_id and c1.prf_npi=a.attr_npi
left join meta2.npi_x_bill_&year. c2 on c2.prf_npi=a.attr_npi
order by def_sub, def_id;
quit;
...
from bene_&epi. x
left join meta2.provider_x_cbsa_&year. z on x.attr_npi=z.provider_id and z.provider_type="phys_npi";
quit;
