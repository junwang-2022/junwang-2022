libname out "D:\SASData\dua_052882\Sndbx\Jun_W\Others\Facility Taxonomy";
libname vrdc "D:\SASData\dua_052882\Sndbx\Jun_W\Others\Facility Taxonomy\VRDC export" access=readonly;
...
data out.ccn_name    ;
     ...
     infile 'D:\SASData\dua_052882\Sndbx\Jun_W\Others\Facility Taxonomy\CCN_INFORMATION_FULL.csv' delimiter = ','
...
**************************************************************;
*** Example code for identifying FAC/PG specialty on VRDC  ***;
*** Actual code: Facility Specialty Summaries_20230303.sas ***;
**************************************************************;
...
left join npi.nppes_npi_spec_x_new b on a.&type._id=b.npi 
...
proc transpose data=&type._grp_spec out=out.&type._spec_sum;
by &type._type &type._id spec_grp &type._spec_total &type._hi_pct &type._hi_spec_desc nppes_spec;
var spec_desc;
run;

data out.&type._spec_sum;
set out.&type._spec_sum;
...
proc sql;
create table out.&type._taxonomy as
...
from out.&type._dx_sum a
left join out.&type._spec_sum b on a.&type._type=b.&type._type and a.&type._id=b.&type._id
left join npi.nppes_npi_spec_x_new c on a.&type._id=c.npi 
left join meta2.ccn_name d on a.&type._id=d.federal_provider_number
left join npi.zip_cbsa e on substr(coalescec(c.prvd_bz_addresszip, d.provider_zip_code),1,5)=e.zip_cd
...
data out.fac_taxonomy2;
set out.fac_taxonomy;
...
proc export data=out.fac_taxonomy2 outfile="D:\SASData\dua_052882\Sndbx\Jun_W\Others\Facility Taxonomy\fac_taxonomy.csv" replace; run;
proc export data=out.pg_taxonomy2 outfile="D:\SASData\dua_052882\Sndbx\Jun_W\Others\Facility Taxonomy\pg_taxonomy.csv" replace; run;
