...
data diagnosis_20230516_3;
set eci00001.diagnosis_20230516_dd;
if substr(sysid,1,1) = '3';
run;

data person_20230516_3;
set eci00001.person_20230516;
if substr(sysid,1,1) = '3';
run;

%V0520F5M( INP      = person_20230516_3,
           IND      = diagnosis_20230516_3,
           INN      = NDC,
           INH      = HCPCS,
           OUTDATA  = eci00001.person_cc_20230516_3,
           IDVAR    = sysid,
           KEEPVAR  = DOB
                      AGE_LAST
                      SEX
