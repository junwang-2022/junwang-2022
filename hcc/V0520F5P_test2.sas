...
run;
	...
	data diagnosis_20230516;
	set eci00001.diagnosis_20230516_dd;
	if substr(sysid,1,1) = 'A';
...
%V0520F5M( INP      = person_20230516,
           IND      = diagnosis_20230516,
           INN      = NDC,
           INH      = HCPCS,
           OUTDATA  = eci00001.person_cc_20230516_A,
           IDVAR    = sysid,
           KEEPVAR  = DOB
                      AGE_LAST
                      SEX
