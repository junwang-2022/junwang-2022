...
run;
	...
	if substr(sysid,1,2) = '01';
	keep sysid diag diagnosis_service_date;
	run;

	data person_20230516_01;
...
%V0520F5M( INP      = person_20230516_01,
           IND      = diagnosis_20230516_01,
           INN      = NDC,
           INH      = HCPCS,
           OUTDATA  = eci00001.person_cc_20230516_01,
           IDVAR    = sysid,
           KEEPVAR  = DOB
                      AGE_LAST
                      SEX
