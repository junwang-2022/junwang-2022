libname out "D:\SASData\dua_052882\Sndbx\Jun_W\Others\NPI POS";
/*libname ccmffs "D:\sas\ccm";*/
libname meta2 "D:\SASData\dua_052882\Sndbx\Jun_W\builder test\meta2" access=readonly;
libname npi "D:\SASData\dua_052882\Sndbx\Jun_W\builder test\NPI" access=readonly;
libname vrdc "D:\SASData\dua_052882\Sndbx\Jun_W\Others\NPI POS\VRDC Export" access=readonly;


**********************************************;
*** VRDC code for identify physician's pos ***;
**********************************************;
...
proc sql;
create table out.&prvdr._pos_&yr. as 
...
from npi_pos a 
left join npi.nppes_npi_spec_x_new b on a.&prvdr.=b.npi
left join meta2.cms_spec_cd c on coalescec(a.npi_spec, b.cms_specialty_code)=c.spec_cd
left join npi.zip_cbsa d on substr(a.prvdr_zip_cd,1,5)=d.zip_cd 
order by &prvdr., type desc;
quit;

proc export data=out.&prvdr._pos_&yr. outfile="D:\SASData\dua_052882\Sndbx\Jun_W\Others\NPI POS\&prvdr._pos_&yr..csv" replace; run;
